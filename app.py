...
# Configuration
# ==========================================
BOT_TOKEN = "8790695854:AAFPylS0bv_YapNDQM9PBMME_4J24bBaepk"
ADMIN_ID = 7244375873
BASE_URL = f"https://api.telegram.org/bot{BOT_TOKEN}/"
BOT_USERNAME = "@SuccessVoltexSms_bot"

# 2oo9 API Configuration
API_2OO9_BASE = "https://api.2oo9.cloud/MXS47FLFX0U/tnevs/@public/api"
API_2OO9_KEY_DEFAULT = "MQFK1S3DFVD"
...
voltx_dynamic_data = {} 
recent_traffic = []
daily_stats = {"date": "", "numbers": 0, "otps": 0} # ЁЯМЯ Daily Stats Tracker
daily_user_otps = {"date": "", "users": {}}

# ЁЯМЯ Caching Variables for Rocket Speed!
    ...
    while True:
        try:
            if voltx_auto_mode and voltx_dynamic_data:
                ...
                top_services = sorted(service_hits, key=lambda x: x[2], reverse=True)[:15] # ЁЯМЯ Top 15 Services
                ...
                for sid, data, hits in top_services:
                    ...
                    top_countries = sorted(country_map.items(), key=lambda x: x[1]["hits"], reverse=True)[:15] # ЁЯМЯ Top 15 Countries
            ...
            pass
        time.sleep(5) # ЁЯМЯ 5 рж╕рзЗржХрзЗржирзНржб ржкрж░ржкрж░ ржмрзНржпрж╛ржХржЧрзНрж░рж╛ржЙржирзНржбрзЗ ржХрзНржпрж╛рж╢ рж░рзЗржбрж┐ рж╣ржмрзЗ
...
def save_local_data():
    ...
    # ЁЯМЯ Firebase ржП рж▓рж╛ржЗржн ржЖржкржбрзЗржЯ ржкрж╛ржарж╛ржирзЛ
...
# ==========================================
GLOBAL_BODY_EMOJIS = {
    "тЮЦ": "5870818207383686839", "ЁЯЪл": "5334807341109908955", "ЁЯШТ": "5334763399299506604",
    "ЁЯЦе": "5334880948259427772", "ЁЯМР": "5334590977837403844", "ЁЯМЯ": "5337102391244263212",
    "ЁЯХУ": "5336983442125001376", "тМЫ": "5337172996211648018", "ЁЯТм": "5337302974806922068",
    "ЁЯФР": "5337255927735163754", "ЁЯНП": "5337132498965010628", "тЭФ": "5336850036145823599",
    "тЪая╕П": "5336944168944047463", "ЁЯФе": "5337267511261960341", "ЁЯТ╕": "5429612421977253466",
    "ЁЯеЪ": "5348390922507817684", "ЁЯСитАНтЪЦ": "5334763399299506604", "ЁЯРБ": "5348494358205207761",
    "ЁЯз╗": "5348486915026884464", "тЪЧ": "5346311574221000149", "ЁЯЫ┤": "5348075478634766440",
    "ЁЯУК": "5353032893096567467", "ЁЯФв": "5226929552319594190", "ЁЯСд": "5352861489541714456",
    "ЁЯУБ": "5352721946054268944", "ЁЯЪА": "5352597830089347330", "ЁЯТО": "5352838545826420397",
    "ЁЯУН": "5352922460897452503", "ЁЯСЛ": "5353027129250453493", "тЬЕ": "5352694861990501856",
    "1я╕ПтГг": "5352651766288652742", "2я╕ПтГг": "5355186458418257716", "3я╕ПтГг": "5352867219028091093",
    "4я╕ПтГг": "5352566657216714037", "5я╕ПтГг": "5353086880835474989", "6я╕ПтГг": "5354859211975071385",
    "7я╕ПтГг": "5352859127309707652", "8я╕ПтГг": "5352957533600389988", "9я╕ПтГг": "5353060913463204207",
    "ЁЯФд": "5352727417842606016", "ЁЯУг": "5352980533150259581", "ЁЯУд": "5353001161878182134",
    "тЬи": "5352552689983067014", "ЁЯФ╣": "5352638632278660622", "ЁЯОЩ": "5355102594886833928",
    "ЁЯТ┤": "5352985330628730418", "ЁЯУЕ": "5352585194295564660", "ЁЯУ┤": "5352974971167611327",
    "тЬПя╕П": "5395444784611480792", "ЁЯУ▒": "5337132498965010628", "ЁЯФЧ": "5420517437885943844",
    "тЭМ": "5420130255174145507", "тЪЩя╕П": "5420155432272438703", "ЁЯлВ": "5420145051336485498",
    "тЮХ": "5420323438508155202", "ЁЯЧС": "5422557736330106570", "ЁЯОБ": "5420396762189831222",
    "тЮд": "5420618897898381296", "ЁЯПв": "5420156334215565595", "ЁЯТ│": "5190899075968441286",
    "ЁЯУЭ": "5192739271886282680", "ЁЯЫб": "5190447043545438788", "ЁЯдЭ": "5192805934073685937",
    "ЁЯТ░": "5190576863226933563", "ЁЯСА": "5190645917711114179", "ЁЯХ╣": "5193100774988617665",
    "ЁЯЯв": "5192812028632274956", "ЁЯзк": "5190781475468915802", "ЁЯОи": "5190751148704833975",
    "ЁЯУВ": "5257969839313526622", "ЁЯМН": "5780471598922337683", "ЁЯУМ": "5318986077455795572",
    "ЁЯУв": "5789428375261023681", "ЁЯЖФ": "5226929552319594190", "ЁЯУИ": "5352877703043258544",
    "ЁЯФФ": "5352980533150259581", "ЁЯПж": "5429612421977253466", "ЁЯз╛": "5192739271886282680",
    "ЁЯСитАНтЪЦя╕П": "5334763399299506604", "ЁЯФН": "5463352748751753567", "ЁЯФС": "5197288647275071607",
    "ЁЯПЖ": "5240021484516185513", "ЁЯЪж": "5429571662737611814", "ЁЯСе": "5420145051336485498", 
    "ЁЯОп": "5352922460897452503", "ЁЯУ╢": "5429353834881261942", "тП│": "5337172996211648018", 
    "ЁЯФ╕": "5429576112323732785", "ЁЯОЙ": "5420396762189831222", "ЁЯТ╡": "5429612421977253466", 
    "ЁЯСС": "5352838545826420397", "тЖ│": "5420618897898381296",
    "ЁЯЗ║ЁЯЗ╕": "5913463998522592692", "ЁЯЗ║ЁЯЗж": "5911406692007941050", "ЁЯЗ╡ЁЯЗ▒": "5913550391789752571",
    "ЁЯЗ░ЁЯЗ┐": "5913724621433082323", "ЁЯЗиЁЯЗ│": "5913779335021466780", "ЁЯЗжЁЯЗ┐": "5911197578640233518",
    "ЁЯЗкЁЯЗ║": "5911106310585193018", "ЁЯЗжЁЯЗ▓": "5913272455866093666", "ЁЯЗ╖ЁЯЗ║": "5913274246867456342",
    "ЁЯЗ║ЁЯЗ┐": "5911051846104912282", "ЁЯЗйЁЯЗк": "5911096835887337583", "ЁЯЗпЁЯЗ╡": "5913293711659241040",
    "ЁЯЗ╣ЁЯЗ╖": "5910995113881901195", "ЁЯЗзЁЯЗ╛": "5911011185649521599", "ЁЯЗмЁЯЗз": "5913443365499703513",
    "ЁЯЗоЁЯЗ│": "5913754823643107921", "ЁЯЗзЁЯЗ╖": "5911148568768418614", "ЁЯЗ┐ЁЯЗ▓": "5913564754160389778",
    "ЁЯЗ╛ЁЯЗк": "5913346492512341993", "ЁЯП┤єаБзєаБвєаБ╖єаБмєаБ│єаБ┐": "5911297801702084799", "ЁЯЗ╗ЁЯЗ│": "5913428887164949581",
    "ЁЯЗ╗ЁЯЗж": "5911211932420938860", "ЁЯЗ╗ЁЯЗ║": "5913511535220625585", "ЁЯЗ║ЁЯЗ╛": "5913623088406204470",
    "ЁЯЗжЁЯЗк": "5913726554168365343", "ЁЯЗ║ЁЯЗм": "5913488939397681980", "ЁЯЗ╣ЁЯЗ▓": "5913315521503170180",
    "ЁЯЗ╣ЁЯЗ│": "5911332947419468671", "ЁЯЗ╣ЁЯЗ╣": "5911228635548750294", "ЁЯЗ╣ЁЯЗм": "5913423260757790970",
    "ЁЯЗ╣ЁЯЗн": "5913617968805187987", "ЁЯЗ╣ЁЯЗ┐": "5911418949844603556", "ЁЯЗ╣ЁЯЗп": "5911287639809463107",
    "ЁЯЗиЁЯЗн": "5913271227505448072", "ЁЯЗ╕ЁЯЗк": "5911156510162949403", "ЁЯЗ╕ЁЯЗ┐": "5913374525763883286",
    "ЁЯЗ╕ЁЯЗ╖": "5913275539652611719", "ЁЯЗ╕ЁЯЗй": "5911387497799094470", "ЁЯЗкЁЯЗ╕": "5911193287967904547",
    "ЁЯЗ▒ЁЯЗ░": "5911293163137406640", "ЁЯЗ╕ЁЯЗ╕": "5911406262511211744", "ЁЯЗ┐ЁЯЗж": "5911203119148044594",
    "ЁЯЗ╕ЁЯЗ┤": "5911397852965244436", "ЁЯЗ╕ЁЯЗз": "5911482712929080608", "ЁЯЗ╕ЁЯЗо": "5913431983836368644",
    "ЁЯЗ╕ЁЯЗ░": "5913751666842145020", "ЁЯЗ╕ЁЯЗм": "5911531460808051849", "ЁЯЗ╕ЁЯЗ▒": "5911210450657218661",
    "ЁЯЗ╕ЁЯЗи": "5911185183364616913", "ЁЯЗ╖ЁЯЗ╕": "5913592598433369871", "ЁЯЗ╕ЁЯЗ│": "5910995302860461643",
    "ЁЯП┤єаБзєаБвєаБ│єаБгєаБ┤єаБ┐": "5911460091336331851", "ЁЯЗ╕ЁЯЗ╣": "5913574331937462345", "ЁЯЗ╕ЁЯЗ▓": "5913587968458625465",
    "ЁЯЗ╝ЁЯЗ╕": "5913325971158602854", "ЁЯЗ░ЁЯЗ│": "5913691898077253637", "ЁЯЗ╗ЁЯЗи": "5911318941531116255",
    "ЁЯЗ▒ЁЯЗи": "5911243659344351824", "ЁЯЗ╡ЁЯЗ╕": "5913684768431541668", "ЁЯЗ╖ЁЯЗ╝": "5911455229433352234",
    "ЁЯЗ╖ЁЯЗ┤": "5913460373570195273", "ЁЯЗ╢ЁЯЗж": "5911260864983339619", "ЁЯЗ╡ЁЯЗ╖": "5911504350974317480",
    "ЁЯЗ╡ЁЯЗ╣": "5911023653939581472", "ЁЯЗ╡ЁЯЗн": "5911268638874145162", "ЁЯЗ╡ЁЯЗк": "5911207993935925780",
    "ЁЯЗ╡ЁЯЗ╛": "5911014265141072316", "ЁЯЗ╡ЁЯЗм": "5911107251183030903", "ЁЯЗ╡ЁЯЗж": "5913428968769327174",
    "ЁЯЗ╡ЁЯЗ╝": "5911283903187915549", "ЁЯЗ╡ЁЯЗ░": "5913705895375672082", "ЁЯЗ┤ЁЯЗ▓": "5913570801474343473",
    "ЁЯЗ│ЁЯЗ┤": "5913617397574537046", "ЁЯЗ│ЁЯЗм": "5911143844304393105", "ЁЯЗ│ЁЯЗк": "5911270086278124251",
    "ЁЯЗ│ЁЯЗ┐": "5913640044937089340", "ЁЯЗ│ЁЯЗ▒": "5913367645226275100", "ЁЯЗ│ЁЯЗ╡": "5913496520014958723",
    "ЁЯЗ│ЁЯЗж": "5911108535378252443", "ЁЯЗ▓ЁЯЗ┐": "5911333419865871464", "ЁЯЗ▓ЁЯЗж": "5911482111633658301",
    "ЁЯЗ▓ЁЯЗк": "5913239436157522151", "ЁЯЗ▓ЁЯЗ│": "5911041383564580038", "ЁЯЗ▓ЁЯЗи": "5911245347266500057",
    "ЁЯЗ▓ЁЯЗй": "5913456847402045950", "ЁЯЗ▓ЁЯЗ╗": "5913501399097806832", "ЁЯЗ▓ЁЯЗ▒": "5911305266355245916",
    "ЁЯЗ▓ЁЯЗ╣": "5911023714069123567", "ЁЯЗзЁЯЗ▓": "5913680005312811090", "ЁЯЗ▓ЁЯЗ╢": "5911378005921370347",
    "ЁЯЗ▓ЁЯЗн": "5913235935759175692", "ЁЯЗ▓ЁЯЗ║": "5913291113204027321", "ЁЯЗ▓ЁЯЗ╜": "5913687302462246518",
    "ЁЯЗлЁЯЗ▓": "5911271104185373336", "ЁЯЗ▓ЁЯЗ╛": "5913654360063087453", "ЁЯЗ░ЁЯЗк": "5911154710571651231",
    "ЁЯЗ▓ЁЯЗм": "5913766918271012920", "ЁЯЗ▓ЁЯЗ░": "5913394029210374721", "ЁЯЗ▒ЁЯЗ║": "5913390842344640293",
    "ЁЯЗ▒ЁЯЗ╣": "5911172315642597775", "ЁЯЗ▒ЁЯЗо": "5911166650580734660", "ЁЯЗ▒ЁЯЗ╛": "5911236989260140996",
    "ЁЯЗ▒ЁЯЗ╖": "5913324167272337727", "ЁЯЗ░ЁЯЗо": "5911294443037660118", "ЁЯЗ╜ЁЯЗ░": "5911433681582429010",
    "ЁЯЗ░ЁЯЗ╝": "5913290705182134003", "ЁЯЗ░ЁЯЗм": "5911202161370337549", "ЁЯЗ▒ЁЯЗж": "5913718526874489279",
    "ЁЯЗ▒ЁЯЗ╗": "5913738489882480243", "ЁЯЗ▒ЁЯЗз": "5911504273664905447", "ЁЯЗ▒ЁЯЗ╕": "5911059881988723711",
    "ЁЯЗоЁЯЗй": "5913479361620611038", "ЁЯЗоЁЯЗ╖": "5911308891307643032", "ЁЯЗоЁЯЗ╢": "5911382442622587735",
    "ЁЯЗоЁЯЗк": "5913440715504881532", "ЁЯЗоЁЯЗ▒": "5911471936856134692", "ЁЯЗоЁЯЗ╣": "5913688444923547525",
    "ЁЯЗпЁЯЗ▓": "5913232280742006526", "ЁЯЗпЁЯЗ┤": "5913234136167878475", "ЁЯЗоЁЯЗ╕": "5911047899029967246",
    "ЁЯЗнЁЯЗ║": "5913767635530551104", "ЁЯЗнЁЯЗ│": "5911406889576436289", "ЁЯЗнЁЯЗ╣": "5913459789454643194",
    "ЁЯЗмЁЯЗ╛": "5913579412883771480", "ЁЯЗмЁЯЗ╝": "5911398694778836149", "ЁЯЗмЁЯЗ│": "5913471858312744319",
    "ЁЯЗмЁЯЗ╣": "5913324858762072330", "ЁЯЗмЁЯЗй": "5913228063084121946", "ЁЯЗмЁЯЗ╖": "5911210399117611448",
    "ЁЯЗмЁЯЗн": "5913391155877252952", "ЁЯЗмЁЯЗк": "5913434771270144023", "ЁЯЗмЁЯЗ▓": "5913657267755945883",
    "ЁЯЗмЁЯЗж": "5911037896051137264", "ЁЯЗлЁЯЗ╖": "5913605586414473124", "ЁЯЗлЁЯЗо": "5911041344909873378",
    "ЁЯЗлЁЯЗп": "5911393832875856716", "ЁЯЗкЁЯЗ╣": "5911078333168227043", "ЁЯЗйЁЯЗ┤": "5911152099231536123",
    "ЁЯЗ╣ЁЯЗ▒": "5911141915864076479", "ЁЯЗкЁЯЗи": "5911273865849347408", "ЁЯЗкЁЯЗм": "5913694831539916769",
    "ЁЯЗ╕ЁЯЗ╗": "5913238624408703010", "ЁЯП┤єаБзєаБвєаБеєаБоєаБзєаБ┐": "5913475719488344315", "ЁЯЗкЁЯЗк": "5910986042910969906",
    "ЁЯЗйЁЯЗ▓": "5911377121158107430", "ЁЯЗйЁЯЗп": "5911407709915190157", "ЁЯЗйЁЯЗ░": "5911206009661034712",
    "ЁЯЗиЁЯЗ╛": "5911023550860366409", "ЁЯЗнЁЯЗ╖": "5913692684056269311", "ЁЯЗиЁЯЗ╖": "5911261745451635030",
    "ЁЯЗиЁЯЗм": "5911338788574990168", "ЁЯЗиЁЯЗй": "5913770362834783827", "ЁЯЗ░ЁЯЗ▓": "5911338582416560604",
    "ЁЯЗ░ЁЯЗн": "5913699998385573485", "ЁЯЗиЁЯЗ▓": "5911172109484167745", "ЁЯЗиЁЯЗж": "5913623736946265914",
    "ЁЯЗиЁЯЗ╗": "5913571501554012193", "ЁЯЗиЁЯЗл": "5913443245240619222", "ЁЯЗ╣ЁЯЗй": "5913299849167507310",
    "ЁЯЗиЁЯЗ┐": "5911198691036764307", "ЁЯЗиЁЯЗ▒": "5911470957603592832", "ЁЯЗиЁЯЗ┤": "5913773060074246009",
    "ЁЯЗзЁЯЗо": "5913766441529642752", "ЁЯЗзЁЯЗ╝": "5911513782722499475", "ЁЯЗзЁЯЗж": "5913700002680541032",
    "ЁЯЗзЁЯЗ┤": "5913638795101606133", "ЁЯЗзЁЯЗ╣": "5913236734623093021", "ЁЯЗзЁЯЗп": "5913735869952430547",
    "ЁЯЗжЁЯЗ╖": "5913573356979884082", "ЁЯЗжЁЯЗ║": "5913632326880858455", "ЁЯЗжЁЯЗ╣": "5911338831524664592",
    "ЁЯЗзЁЯЗ╕": "5911451643135660214", "ЁЯЗзЁЯЗн": "5913581663446634403", "ЁЯЗзЁЯЗй": "5911365056594973179",
    "ЁЯЗзЁЯЗз": "5911016996740272263", "ЁЯЗзЁЯЗк": "5913529642802745141", "ЁЯЗзЁЯЗ┐": "5913355005137522807",
    "ЁЯЗжЁЯЗм": "5913389025573475085", "ЁЯЗжЁЯЗ┤": "5913753316109586411", "ЁЯЗжЁЯЗй": "5911314702398396902",
    "ЁЯЗйЁЯЗ┐": "5913782968563800236", "ЁЯЗжЁЯЗ▒": "5911357458797826163", "ЁЯЗжЁЯЗл": "5913492040364068694",
    "ЁЯЗ┐ЁЯЗ╝": "5911092502265336396", "ЁЯЗиЁЯЗ║": "5431551436502611633", "ЁЯЗ░ЁЯЗ╡": "5434142701941437163",
    "ЁЯЗ╗ЁЯЗк": "5434009132753499322", "ЁЯЗ╕ЁЯЗ╛": "5433910876786670092", "ЁЯЗ▓ЁЯЗ▓": "5433666360003540231",
    "ЁЯЗ│ЁЯЗо": "5334807849418003620", "ЁЯЗ░ЁЯЗ╖": "5913371673905598425", "ЁЯЗмЁЯЗ╢": "5911306279967529251",
    "ЁЯЗмЁЯЗ▒": "5292014752283774878", "ЁЯЗлЁЯЗ┤": "5296469342039327674", "ЁЯЗиЁЯЗо": "5222233374948602940",
    "ЁЯЗзЁЯЗ│": "5911336409163109113", "ЁЯЗзЁЯЗм": "5294329219965272288", "ЁЯЗзЁЯЗл": "5913407764515786948",
    "ЁЯЗкЁЯЗ╖": "5433723401464198287", "ЁЯЗ▓ЁЯЗ╝": "5433968339154122439", "ЁЯЗ▓ЁЯЗ╖": "5433859405898594234",
    "ЁЯЗ│ЁЯЗ╖": "5434131139889478358", "ЁЯЗ╕ЁЯЗж": "4985897134424328239", "ЁЯЗ╣ЁЯЗ┤": "5433640100573491806",
    "ЁЯЗ╣ЁЯЗ╗": "5433684690923961019", "ЁЯЗ╣ЁЯЗ╝": "5366187256937726720", "ЁЯЗнЁЯЗ░": "5292166459118606932",
    "ЁЯЗ▓ЁЯЗ┤": "6323557758096377611"
}
...
# ==========================================
PREMIUM_APPS = {
    "Facebook": {"emoji": "ЁЯУШ", "id": "5429172110520003976"},
    "WhatsApp": {"emoji": "ЁЯТм", "id": "5429612632430654504"},
    "Telegram": {"emoji": "тЬИя╕П", "id": "5429136513831057777"},
    "Instagram": {"emoji": "ЁЯУ╕", "id": "5429478178479447442"},
    "Google": {"emoji": "ЁЯФН", "id": "5429558795015593080"},
    "Microsoft": {"emoji": "ЁЯкЯ", "id": "5979047775470358891"},
    "TikTok": {"emoji": "ЁЯО╡", "id": "5429132656950419591"},
    "Bkash": {"emoji": "ЁЯПж", "id": "5431552076452766597"},
    "Binance": {"emoji": "ЁЯТ▒", "id": "5429438106434575354"},
    "Snapchat": {"emoji": "ЁЯС╗", "id": "5429398137468919845"},
    "Uber": {"emoji": "ЁЯЪЧ", "id": "5298715455316303708"},
    "Discord": {"emoji": "ЁЯОм", "id": "5429594374524676604"},
    "Amazon": {"emoji": "ЁЯМЯ", "id": "5431358656895568355"},
    "Viber": {"emoji": "ЁЯТЬ", "id": "5429470576387335368"},
    "Twitter": {"emoji": "ЁЯРж", "id": "5431899135580087595"},
    "Netflix": {"emoji": "ЁЯОе", "id": "5431641055290235797"},
    "Spotify": {"emoji": "ЁЯО╡", "id": "5429235839244739644"},
    "Foodpanda": {"emoji": "ЁЯР╝", "id": "5336879280578138635"},
    "Pathao": {"emoji": "ЁЯЫ╡", "id": "5336879280578138635"},
    "ChatGPT": {"emoji": "ЁЯдЦ", "id": "5429503209548847635"},
    "Imo": {"emoji": "ЁЯТн", "id": "5431378937731129128"},
    "Other": {"emoji": "ЁЯУ╢", "id": "5429353834881261942"}
}
...
COUNTRY_CODES = {
    "1": "ЁЯЗ║ЁЯЗ╕ USA/Canada", "380": "ЁЯЗ║ЁЯЗж Ukraine", "48": "ЁЯЗ╡ЁЯЗ▒ Poland", "7": "ЁЯЗ░ЁЯЗ┐ Kazakhstan",
    "86": "ЁЯЗиЁЯЗ│ China", "994": "ЁЯЗжЁЯЗ┐ Azerbaijan", "374": "ЁЯЗжЁЯЗ▓ Armenia", "79": "ЁЯЗ╖ЁЯЗ║ Russia",
    "998": "ЁЯЗ║ЁЯЗ┐ Uzbekistan", "49": "ЁЯЗйЁЯЗк Germany", "81": "ЁЯЗпЁЯЗ╡ Japan", "90": "ЁЯЗ╣ЁЯЗ╖ Turkey",
    "375": "ЁЯЗзЁЯЗ╛ Belarus", "44": "ЁЯЗмЁЯЗз United Kingdom", "91": "ЁЯЗоЁЯЗ│ India", "55": "ЁЯЗзЁЯЗ╖ Brazil",
    "260": "ЁЯЗ┐ЁЯЗ▓ Zambia", "967": "ЁЯЗ╛ЁЯЗк Yemen", "84": "ЁЯЗ╗ЁЯЗ│ Vietnam", "379": "ЁЯЗ╗ЁЯЗж Vatican City",
    "678": "ЁЯЗ╗ЁЯЗ║ Vanuatu", "598": "ЁЯЗ║ЁЯЗ╛ Uruguay", "971": "ЁЯЗжЁЯЗк UAE", "256": "ЁЯЗ║ЁЯЗм Uganda",
    "993": "ЁЯЗ╣ЁЯЗ▓ Turkmenistan", "216": "ЁЯЗ╣ЁЯЗ│ Tunisia", "228": "ЁЯЗ╣ЁЯЗм Togo", "66": "ЁЯЗ╣ЁЯЗн Thailand",
    "255": "ЁЯЗ╣ЁЯЗ┐ Tanzania", "992": "ЁЯЗ╣ЁЯЗп Tajikistan", "41": "ЁЯЗиЁЯЗн Switzerland", "46": "ЁЯЗ╕ЁЯЗк Sweden",
    "268": "ЁЯЗ╕ЁЯЗ┐ Eswatini", "597": "ЁЯЗ╕ЁЯЗ╖ Suriname", "249": "ЁЯЗ╕ЁЯЗй Sudan", "34": "ЁЯЗкЁЯЗ╕ Spain",
    "94": "ЁЯЗ▒ЁЯЗ░ Sri Lanka", "211": "ЁЯЗ╕ЁЯЗ╕ South Sudan", "27": "ЁЯЗ┐ЁЯЗж South Africa", "252": "ЁЯЗ╕ЁЯЗ┤ Somalia",
    "677": "ЁЯЗ╕ЁЯЗз Solomon Islands", "386": "ЁЯЗ╕ЁЯЗо Slovenia", "421": "ЁЯЗ╕ЁЯЗ░ Slovakia", "65": "ЁЯЗ╕ЁЯЗм Singapore",
    "232": "ЁЯЗ╕ЁЯЗ▒ Sierra Leone", "248": "ЁЯЗ╕ЁЯЗи Seychelles", "381": "ЁЯЗ╖ЁЯЗ╕ Serbia", "221": "ЁЯЗ╕ЁЯЗ│ Senegal",
    "239": "ЁЯЗ╕ЁЯЗ╣ Sao Tome", "378": "ЁЯЗ╕ЁЯЗ▓ San Marino", "685": "ЁЯЗ╝ЁЯЗ╕ Samoa", "970": "ЁЯЗ╡ЁЯЗ╕ Palestine",
    "250": "ЁЯЗ╖ЁЯЗ╝ Rwanda", "40": "ЁЯЗ╖ЁЯЗ┤ Romania", "974": "ЁЯЗ╢ЁЯЗж Qatar", "351": "ЁЯЗ╡ЁЯЗ╣ Portugal",
    "63": "ЁЯЗ╡ЁЯЗн Philippines", "51": "ЁЯЗ╡ЁЯЗк Peru", "595": "ЁЯЗ╡ЁЯЗ╛ Paraguay", "675": "ЁЯЗ╡ЁЯЗм Papua New Guinea",
    "507": "ЁЯЗ╡ЁЯЗж Panama", "680": "ЁЯЗ╡ЁЯЗ╝ Palau", "92": "ЁЯЗ╡ЁЯЗ░ Pakistan", "968": "ЁЯЗ┤ЁЯЗ▓ Oman",
    "47": "ЁЯЗ│ЁЯЗ┤ Norway", "234": "ЁЯЗ│ЁЯЗм Nigeria", "227": "ЁЯЗ│ЁЯЗк Niger", "64": "ЁЯЗ│ЁЯЗ┐ New Zealand",
    "31": "ЁЯЗ│ЁЯЗ▒ Netherlands", "977": "ЁЯЗ│ЁЯЗ╡ Nepal", "264": "ЁЯЗ│ЁЯЗж Namibia", "258": "ЁЯЗ▓ЁЯЗ┐ Mozambique",
    "212": "ЁЯЗ▓ЁЯЗж Morocco", "382": "ЁЯЗ▓ЁЯЗк Montenegro", "976": "ЁЯЗ▓ЁЯЗ│ Mongolia", "377": "ЁЯЗ▓ЁЯЗи Monaco",
    "373": "ЁЯЗ▓ЁЯЗй Moldova", "960": "ЁЯЗ▓ЁЯЗ╗ Maldives", "223": "ЁЯЗ▓ЁЯЗ▒ Mali", "356": "ЁЯЗ▓ЁЯЗ╣ Malta",
    "596": "ЁЯЗ▓ЁЯЗ╢ Martinique", "692": "ЁЯЗ▓ЁЯЗн Marshall Islands", "230": "ЁЯЗ▓ЁЯЗ║ Mauritius", "52": "ЁЯЗ▓ЁЯЗ╜ Mexico",
    "691": "ЁЯЗлЁЯЗ▓ Micronesia", "60": "ЁЯЗ▓ЁЯЗ╛ Malaysia", "254": "ЁЯЗ░ЁЯЗк Kenya", "261": "ЁЯЗ▓ЁЯЗм Madagascar",
    "389": "ЁЯЗ▓ЁЯЗ░ North Macedonia", "352": "ЁЯЗ▒ЁЯЗ║ Luxembourg", "370": "ЁЯЗ▒ЁЯЗ╣ Lithuania", "423": "ЁЯЗ▒ЁЯЗо Liechtenstein",
    "218": "ЁЯЗ▒ЁЯЗ╛ Libya", "231": "ЁЯЗ▒ЁЯЗ╖ Liberia", "686": "ЁЯЗ░ЁЯЗо Kiribati", "383": "ЁЯЗ╜ЁЯЗ░ Kosovo",
    "965": "ЁЯЗ░ЁЯЗ╝ Kuwait", "996": "ЁЯЗ░ЁЯЗм Kyrgyzstan", "856": "ЁЯЗ▒ЁЯЗж Laos", "371": "ЁЯЗ▒ЁЯЗ╗ Latvia",
    "961": "ЁЯЗ▒ЁЯЗз Lebanon", "266": "ЁЯЗ▒ЁЯЗ╕ Lesotho", "62": "ЁЯЗоЁЯЗй Indonesia", "98": "ЁЯЗоЁЯЗ╖ Iran",
    "964": "ЁЯЗоЁЯЗ╢ Iraq", "353": "ЁЯЗоЁЯЗк Ireland", "972": "ЁЯЗоЁЯЗ▒ Israel", "39": "ЁЯЗоЁЯЗ╣ Italy",
    "962": "ЁЯЗпЁЯЗ┤ Jordan", "354": "ЁЯЗоЁЯЗ╕ Iceland", "36": "ЁЯЗнЁЯЗ║ Hungary", "504": "ЁЯЗнЁЯЗ│ Honduras",
    "509": "ЁЯЗнЁЯЗ╣ Haiti", "592": "ЁЯЗмЁЯЗ╛ Guyana", "245": "ЁЯЗмЁЯЗ╝ Guinea-Bissau", "224": "ЁЯЗмЁЯЗ│ Guinea",
    "502": "ЁЯЗмЁЯЗ╣ Guatemala", "30": "ЁЯЗмЁЯЗ╖ Greece", "233": "ЁЯЗмЁЯЗн Ghana", "995": "ЁЯЗмЁЯЗк Georgia",
    "220": "ЁЯЗмЁЯЗ▓ Gambia", "241": "ЁЯЗмЁЯЗж Gabon", "33": "ЁЯЗлЁЯЗ╖ France", "358": "ЁЯЗлЁЯЗо Finland",
    "679": "ЁЯЗлЁЯЗп Fiji", "251": "ЁЯЗкЁЯЗ╣ Ethiopia", "670": "ЁЯЗ╣ЁЯЗ▒ Timor-Leste", "593": "ЁЯЗкЁЯЗи Ecuador",
    "20": "ЁЯЗкЁЯЗм Egypt", "503": "ЁЯЗ╕ЁЯЗ╗ El Salvador", "372": "ЁЯЗкЁЯЗк Estonia", "253": "ЁЯЗйЁЯЗп Djibouti",
    "45": "ЁЯЗйЁЯЗ░ Denmark", "357": "ЁЯЗиЁЯЗ╛ Cyprus", "385": "ЁЯЗнЁЯЗ╖ Croatia", "506": "ЁЯЗиЁЯЗ╖ Costa Rica",
    "242": "ЁЯЗиЁЯЗм Congo", "243": "ЁЯЗиЁЯЗй DR Congo", "269": "ЁЯЗ░ЁЯЗ▓ Comoros", "855": "ЁЯЗ░ЁЯЗн Cambodia",
    "237": "ЁЯЗиЁЯЗ▓ Cameroon", "238": "ЁЯЗиЁЯЗ╗ Cape Verde", "236": "ЁЯЗиЁЯЗл CAR", "235": "ЁЯЗ╣ЁЯЗй Chad",
    "420": "ЁЯЗиЁЯЗ┐ Czechia", "56": "ЁЯЗиЁЯЗ▒ Chile", "57": "ЁЯЗиЁЯЗ┤ Colombia", "257": "ЁЯЗзЁЯЗо Burundi",
    "267": "ЁЯЗзЁЯЗ╝ Botswana", "387": "ЁЯЗзЁЯЗж Bosnia", "591": "ЁЯЗзЁЯЗ┤ Bolivia", "975": "ЁЯЗзЁЯЗ╣ Bhutan",
    "229": "ЁЯЗзЁЯЗп Benin", "54": "ЁЯЗжЁЯЗ╖ Argentina", "61": "ЁЯЗжЁЯЗ║ Australia", "43": "ЁЯЗжЁЯЗ╣ Austria",
    "973": "ЁЯЗзЁЯЗн Bahrain", "880": "ЁЯЗзЁЯЗй Bangladesh", "32": "ЁЯЗзЁЯЗк Belgium", "501": "ЁЯЗзЁЯЗ┐ Belize",
    "244": "ЁЯЗжЁЯЗ┤ Angola", "376": "ЁЯЗжЁЯЗй Andorra", "213": "ЁЯЗйЁЯЗ┐ Algeria", "355": "ЁЯЗжЁЯЗ▒ Albania",
    "93": "ЁЯЗжЁЯЗл Afghanistan", "263": "ЁЯЗ┐ЁЯЗ╝ Zimbabwe", "53": "ЁЯЗиЁЯЗ║ Cuba", "850": "ЁЯЗ░ЁЯЗ╡ North Korea",
    "58": "ЁЯЗ╗ЁЯЗк Venezuela", "963": "ЁЯЗ╕ЁЯЗ╛ Syria", "95": "ЁЯЗ▓ЁЯЗ▓ Myanmar", "505": "ЁЯЗ│ЁЯЗо Nicaragua",
    "82": "ЁЯЗ░ЁЯЗ╖ South Korea", "240": "ЁЯЗмЁЯЗ╢ Equatorial Guinea", "299": "ЁЯЗмЁЯЗ▒ Greenland", "298": "ЁЯЗлЁЯЗ┤ Faroe Islands",
    "225": "ЁЯЗиЁЯЗо Ivory Coast", "673": "ЁЯЗзЁЯЗ│ Brunei", "359": "ЁЯЗзЁЯЗм Bulgaria", "226": "ЁЯЗзЁЯЗл Burkina Faso",
    "291": "ЁЯЗкЁЯЗ╖ Eritrea", "265": "ЁЯЗ▓ЁЯЗ╝ Malawi", "222": "ЁЯЗ▓ЁЯЗ╖ Mauritania", "674": "ЁЯЗ│ЁЯЗ╖ Nauru",
    "966": "ЁЯЗ╕ЁЯЗж Saudi Arabia", "676": "ЁЯЗ╣ЁЯЗ┤ Tonga", "688": "ЁЯЗ╣ЁЯЗ╗ Tuvalu", "886": "ЁЯЗ╣ЁЯЗ╝ Taiwan",
    "852": "ЁЯЗнЁЯЗ░ Hong Kong", "853": "ЁЯЗ▓ЁЯЗ┤ Macau", "297": "ЁЯЗжЁЯЗ╝ Aruba", "599": "ЁЯЗиЁЯЗ╝ Curacao",
    "500": "ЁЯЗлЁЯЗ░ Falkland Islands", "594": "ЁЯЗмЁЯЗл French Guiana", "590": "ЁЯЗмЁЯЗ╡ Guadeloupe", "262": "ЁЯЗ╖ЁЯЗк Reunion",
    "687": "ЁЯЗ│ЁЯЗи New Caledonia", "683": "ЁЯЗ│ЁЯЗ║ Niue", "672": "ЁЯЗ│ЁЯЗл Norfolk Island", "681": "ЁЯЗ╝ЁЯЗл Wallis and Futuna",
    "682": "ЁЯЗиЁЯЗ░ Cook Islands", "689": "ЁЯЗ╡ЁЯЗл French Polynesia", "350": "ЁЯЗмЁЯЗо Gibraltar", "508": "ЁЯЗ╡ЁЯЗ▓ Saint Pierre"
}
...
def get_country_info(range_str):
    ...
    return clean_range[:3], f"ЁЯП│я╕П Other (+{clean_range[:3]})"
...
def extract_otp_code(message_text):
    # ЁЯМЯ рж╕рзНржкрзЗрж╕ ржмрж╛ рж╣рж╛ржЗржлрзЗржирж╕рж╣ рзй-рзо ржбрж┐ржЬрж┐ржЯрзЗрж░ ржХрзЛржб ржзрж░рж╛рж░ рж▓ржЬрж┐ржХ
...
def deliver_to_inbox(user_id, service_name, raw_number, msg_text, current_balance, reward):
    ...
    text = (
        f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
        f"<blockquote>{service_html} <code>+{clean_raw_number}</code></blockquote>\n"
        f"<blockquote><tg-emoji emoji-id=\"5420323438508155202\">тЮХ</tg-emoji> <b>ADDED</b>  тЮЬ {reward:.2f} TK</blockquote>\n"
        f"<blockquote><tg-emoji emoji-id=\"5190899075968441286\">ЁЯТ│</tg-emoji> <b>BALANCE</b> тЮЬ {current_balance:.2f} TK</blockquote>\n"
        f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ"
    )
...
def generate_otp_display(service_name, raw_number, message_text):
    ...
    text = (
        f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ\n"
        f"{service_html} тЮЬ {country_emoji} <code>{html.escape(masked_number)}</code>\n"
        f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ"
    )
    
    otp = extract_otp_code(message_text)
    
    # ЁЯМЯ рж░рзЗржЮрзНржЬ ржмрзЗрж░ ржХрж░рж╛рж░ рж▓ржЬрж┐ржХ (ржбрж┐ржлрж▓рзНржЯ рзл ржбрж┐ржЬрж┐ржЯ)
    ...
    # ЁЯМЯ ржкрзНрж░ржержо рж▓рж╛ржЗржи (CHANNEL ржПржмржВ OTP)
    row1 = []
    main_channel_link = bot_settings.get("main_channel_link", "")
    if main_channel_link:
        row1.append({"text": "ЁЭЧЦЁЭЧЫЁЭЧФЁЭЧбЁЭЧбЁЭЧШЁЭЧЯ", "url": main_channel_link, "icon_custom_emoji_id": "5429353834881261942", "style": "primary"})
        
    row1.append({"text": f"{otp}", "icon_custom_emoji_id": srv_eid, "copy_text": {"text": otp}, "style": "success"})
    
    markup["inline_keyboard"].append(row1)
    
    # ЁЯМЯ ржжрзНржмрж┐рждрзАрзЯ рж▓рж╛ржЗржи (GET NUMBER)
                ...
                for otp_data in reversed(otps):
                    ...
                    if sig not in recent_success_otps:
                        ...
                        if owner_id:
                            ...
                            # ЁЯМЯ ржЗржиржмржХрзНрж╕рзЗ ржорзЗрж╕рзЗржЬ ржкрж╛ржарж╛ржирзЛрж░ ржлрж╛ржВрж╢ржи ржХрж▓ ржХрж░рж╛ рж╣рж▓рзЛ
...
def init_firebase_from_file():
    ...
    if os.path.exists("temp_firebase.json"):
        try:
            ...
            print("тЬЕ Firebase Auto-Connected on Startup!")
            ...
            if doc.exists:
                ...
                print("тЬЕ Settings synced from Firebase!")
        except Exception as e:
            print(f"тЭМ Firebase Auto-Connect Error: {e}")
...
def update_user_stats(user_id, balance_add, invite_add):
    ...
    if user_id in user_cache:
        user_cache[user_id]["balance"] = round(user_cache[user_id]["balance"] + bal_add, 2) # ЁЯМЯ Fix: Round balance
...
def get_force_join_alert_keyboard():
    ...
    kb["inline_keyboard"].append([{"text": "тЬЕ I HAVE JOINED", "callback_data": "check_fj_joined", "style": "success"}])
    return kb
...
def dxa_otp_control_keyboard():
    ...
    # ржЕрзНржпрж╛ржб ржХрж░рж╛ рж╕рзНржкрзЗрж╕рж┐ржлрж┐ржХ рж╕рж╛рж░рзНржнрж┐рж╕ рж░рзЗржЯржЧрзБрж▓рзЛ ржбрж╛рзЯржирж╛ржорж┐ржХ ржЗржирж▓рж╛ржЗржи ржмрж╛ржЯржи рж╣рж┐рж╕рзЗржмрзЗ ржжрзЗржЦрж╛ржирзЛрж░ ржЬржирзНржп
...
def get_owner_panel_text():
    ...
    return (
        "<b>ЁЯУК OWNER ZONE ЁЯУК</b>\n"
        "тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ\n"
        "<b>ЁЯУК DATABASE OVERVIEW</b>\n"
        "тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
        f"<blockquote><b>ЁЯСд TOTAL USER         ┬╗ {get_total_users()}</b></blockquote>\n"
        f"<blockquote><b>ЁЯУ▒ TODAY NUMBER  ┬╗ {daily_stats['numbers']}</b></blockquote>\n"
        f"<blockquote><b>ЁЯТм TODAY OTP           ┬╗ {daily_stats['otps']}</b></blockquote>\n"
        "тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ"
    )
...
def get_leaderboard_text():
    ...
    msg = "<blockquote><tg-emoji emoji-id=\"5240021484516185513\">ЁЯПЖ</tg-emoji> <b>ЁЭЧзЁЭЧвЁЭЧг ЁЭЯ▒ ЁЭЧЯЁЭЧШЁЭЧФЁЭЧЧЁЭЧШЁЭЧеЁЭЧХЁЭЧвЁЭЧФЁЭЧеЁЭЧЧ (TODAY)</b></blockquote>\nтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ\n"
    emoji_map = [("1я╕ПтГг", "5238176680098440792"), ("2я╕ПтГг", "5237806896299157399"), ("3я╕ПтГг", "5239965456667812809"), ("4я╕ПтГг", "5237911487342751418"), ("5я╕ПтГг", "5240278297790686165")]
    
    if not top_users: 
        msg += "<i>No OTPs received today.</i>\n"
    else:
        for idx, (uid_str, otp_count) in enumerate(top_users):
            user_data = get_user(int(uid_str))
            fname = user_data["first_name"] if user_data else "User"
            safe_fname = html.escape(str(fname))
            emoji_char, emoji_id = emoji_map[idx]
            msg += f"<blockquote><tg-emoji emoji-id=\"{emoji_id}\">{emoji_char}</tg-emoji> <a href='tg://user?id={uid_str}'>{safe_fname}</a> - {otp_count} OTP</blockquote>\n"
...
def get_live_traffic_content():
    ...
    if not hits_to_show:
        return "тХФтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХЧ\nтХС  <tg-emoji emoji-id=\"5352877703043258544\">ЁЯУИ</tg-emoji> <b>15M LIVE TRAFFIC</b>\nтХЪтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХЭ\n<i>No traffic data available.</i>\nтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ", markup
    ...
    msg = "тХФтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХЧ\nтХС  <tg-emoji emoji-id=\"5352877703043258544\">ЁЯУИ</tg-emoji> <b>15M LIVE TRAFFIC</b>\nтХЪтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХРтХЭ\n"
    fire_emoji_id = "5337267511261960341"
    
    for i, (sid, data) in enumerate(sorted_services):
        msg += f"<tg-emoji emoji-id=\"{data['emoji_id']}\">{data['normal_emoji']}</tg-emoji> {html.escape(str(sid))} тЮЬ <tg-emoji emoji-id=\"{fire_emoji_id}\">ЁЯФе</tg-emoji> {data['count']} OTP\n"
        if i < len(sorted_services) - 1: msg += "тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
    msg += "тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ"
    return msg, markup

def get_services_content():
    global cached_services_kb
    if cached_services_kb:
        return "ЁЯУ▒ <b>Select Top Service:</b>", cached_services_kb
    return "тП│ <b>Loading services, please try again in a few seconds...</b>", None

def get_countries_content(sid_short):
    global cached_countries_kb
    if sid_short in cached_countries_kb:
        return f"ЁЯМН <b>Select Country:</b>", cached_countries_kb[sid_short], None
    return None, None, "тЭМ <b>No active countries for this service. (Out of Stock)</b>"
...
def get_number_allocation_content(sid_short, c_code, user_id=None):
    ...
    # ЁЯМЯ ржПржкрж┐ржЖржЗ рж▓рж┐рж╕рзНржЯрзЗ ржирж╛ ржерж╛ржХрж▓рзЗржУ рж▓рж┐ржВржХрзЗрж░ рж░рзЗржЮрзНржЬ ржжрж┐рзЯрзЗ рж╕рж░рж╛рж╕рж░рж┐ рж░рж┐ржХрзЛрзЯрзЗрж╕рзНржЯ ржХрж░ржмрзЗ
    if not best_ranges: 
        best_ranges = [c_code]
    ...
    if fetched_numbers:
        ...
        msg = (
            ...
            f"<tg-emoji emoji-id=\"5337172996211648018\">тМЫ</tg-emoji> <b>ACTIVE NUMBER 15M</b>\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"{service_html} тЮЬ {country_with_flag}\n"
            f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ"
        )
        ...
        return f"тЭМ <b>Out of stock in these ranges. Please try again.</b>", {"inline_keyboard": [[{"text": "BACK", "callback_data": f"srv_{sid_short}", "icon_custom_emoji_id": "5438541186539232243", "style": "danger"}]]}
...
def handle_message(message):
    ...
    # ЁЯМЯ ржмржЯ рж╢рзБржзрзБржорж╛рждрзНрж░ ржЗржиржмржХрзНрж╕рзЗрж░ ржорзЗрж╕рзЗржЬрзЗ рж░рж┐ржкрзНрж▓рж╛ржЗ ржжрж┐ржмрзЗ (ржЧрзНрж░рзБржк ржЗржЧржирзЛрж░ ржХрж░ржмрзЗ)
    ...
    if text == "ЁЯФЩ BACK" and user_id == ADMIN_ID:
        send_message(chat_id, "тЭМ <b>Action Cancelled!</b>", reply_markup=get_main_keyboard(user_id)) 
    ...
    if "chat_shared" in message:
        ...
        if user_id == ADMIN_ID and user_id in user_states:
            ...
            send_message(chat_id, "тЬЕ <b>Successfully Selected!</b>", reply_markup=get_main_keyboard(user_id)) 
            ...
            if state == "waiting_otp_group":
                ...
                save_local_data()
                if target_msg_id: edit_message(chat_id, target_msg_id, "ЁЯЫб <b>OTP GROUP MANAGEMENT</b>\nManage settings below:", reply_markup=get_otp_group_keyboard())
                ...
                save_local_data()
                if target_msg_id: edit_message(chat_id, target_msg_id, "тЪЩя╕П <b>DXA CONTROL PANEL</b>\nManage core bot configurations:", reply_markup=dxa_control_keyboard())
                del user_states[user_id]
                return
                ...
                if chat_details:
                    ...
                    save_local_data()
                    if target_msg_id: edit_message(chat_id, target_msg_id, "ЁЯФЧ <b>FORCE JOIN SYSTEM</b>\nManage channels below:", reply_markup=get_force_join_keyboard())
                else:
                    if target_msg_id: edit_message(chat_id, target_msg_id, "тЭМ <b>Failed to verify channel! Make sure bot is admin.</b>", reply_markup=get_back_only_keyboard())
                del user_states[user_id]
                return

    if not is_user_joined(user_id):
        send_message(chat_id, "тЪая╕П <b>Please join our channels to use the bot!</b>", reply_markup=get_force_join_alert_keyboard())
        return
    ...
    if user_id == ADMIN_ID and user_id in user_states:
        ...
        if state == "waiting_vk_key":
            ...
            save_local_data()
            if target_msg_id: edit_message(chat_id, target_msg_id, "ЁЯФС <b>VOLTX KEY SYSTEM</b>\nManage API Keys below:", reply_markup=get_voltx_keys_keyboard())
            del user_states[user_id]
            ...
            if text.startswith("http"):
                ...
                if target_msg_id: edit_message(chat_id, target_msg_id, "тЭМ <b>Invalid URL format. Must start with http/https.</b>", reply_markup=get_back_only_keyboard())
            del user_states[user_id]
            delete_message(chat_id, message_id)
            return
            ...
            if target_msg_id: edit_message(chat_id, target_msg_id, "тП│ <b>Broadcasting message to all users...</b>")
            ...
            try:
                # ЁЯМЯ ржлрж╛ржЗрж▓ ржЖржкрж▓рзЛржб рж╕рж╛ржкрзЛрж░рзНржЯ ржЕрзНржпрж╛ржб ржХрж░рж╛ рж╣рж▓рзЛ
                ...
                # ЁЯМЯ рж╕рзНржорж╛рж░рзНржЯ ржХрзЛржЯ (Smart Quotes) ржмрж╛ ржнрзБрж▓ ржЯрзЗржХрзНрж╕ржЯ ржлрж┐ржХрзНрж╕
                text = text.replace("тАЬ", '"').replace("тАЭ", '"').replace("тАШ", "'").replace("тАЩ", "'")
                ...
                try:
                    ...
                    # ЁЯМЯ Firebase ржП рж╕рзЗржЯрж┐ржВрж╕ ржЪрзЗржХ ржПржмржВ рж╕рзЗржн/рж╕рж┐ржЩрзНржХ ржХрж░рж╛рж░ рж▓ржЬрж┐ржХ
                    try:
                    ...
                    if target_msg_id: edit_message(chat_id, target_msg_id, "тП│ <b>Syncing SQLite data to Firebase... Please wait.</b>")
                    ...
                    send_message(chat_id, "тЬЕ <b>Firebase successfully connected & Synced!</b>")
                except Exception as e:
                    if target_msg_id: edit_message(chat_id, target_msg_id, f"тЭМ <b>Failed to connect to Firebase:</b>\n<code>{html.escape(str(e))}</code>", reply_markup=get_back_only_keyboard())
            except Exception:
                if target_msg_id: edit_message(chat_id, target_msg_id, "тЪая╕П <b>Invalid JSON format. Please upload the .json file directly.</b>", reply_markup=get_back_only_keyboard())
            del user_states[user_id]
            delete_message(chat_id, message_id)
            return
            ...
            try:
                ...
                if amount < min_w:
                    if target_msg_id: edit_message(chat_id, target_msg_id, f"тЭМ <b>Minimum withdraw is {min_w} BDT.</b>\nTry again:", reply_markup=get_back_only_keyboard())
                elif amount > bal:
                    if target_msg_id: edit_message(chat_id, target_msg_id, f"тЭМ <b>Insufficient balance! You only have {bal:.2f} BDT.</b>\nTry again:", reply_markup=get_back_only_keyboard())
                else:
                    user_states[user_id] = {"state": f"waiting_withdraw_number_{method}_{amount}", "msg_id": target_msg_id}
                    if target_msg_id: edit_message(chat_id, target_msg_id, f"тЬЕ <b>Amount Set: {amount:.2f} BDT</b>\n\nЁЯТ│ <b>Method:</b> {method}\nЁЯТм <b>Now send your {method} account number:</b>", reply_markup=get_back_only_keyboard())
            except ValueError:
                if target_msg_id: edit_message(chat_id, target_msg_id, "тЭМ <b>Invalid amount. Send numbers only.</b>\nTry again:", reply_markup=get_back_only_keyboard())
            delete_message(chat_id, message_id)
            return
            ...
            if bal < amount:
                if target_msg_id: edit_message(chat_id, target_msg_id, "тЭМ <b>Insufficient balance!</b>", reply_markup=get_main_keyboard(user_id))
            else:
                ...
                if w_group:
                    w_msg = (
                        f"<tg-emoji emoji-id=\"5420396762189831222\">ЁЯЖХ</tg-emoji> <b>NEW WITHDRAW REQUEST</b>\n"
                        f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ\n"
                        f"<tg-emoji emoji-id=\"5352861489541714456\">ЁЯСд</tg-emoji> <b>User:</b> <a href='tg://user?id={user_id}'>{html.escape(first_name)}</a>\n"
                        f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
                        f"<tg-emoji emoji-id=\"5226929552319594190\">ЁЯЖФ</tg-emoji> <b>ID:</b> <code>{user_id}</code>\n"
                        f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
                        f"<tg-emoji emoji-id=\"5429612421977253466\">ЁЯТ╡</tg-emoji> <b>Amount:</b> <b>{amount:.2f} BDT</b>\n"
                        f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
                        f"<tg-emoji emoji-id=\"5190899075968441286\">ЁЯТ│</tg-emoji> <b>Method:</b> {method}\n"
                        f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
                        f"<tg-emoji emoji-id=\"5337132498965010628\">ЁЯУЮ</tg-emoji> <b>Number:</b> <code>{account_number}</code>\n"
                        f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ"
                    )
                ...
                success_msg = (
                    f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ\n"
                    f"<tg-emoji emoji-id=\"5429612421977253466\">ЁЯТ╡</tg-emoji> <b>Amount:</b> {amount:.2f} BDT\n"
                    f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
                    f"<tg-emoji emoji-id=\"5190899075968441286\">ЁЯТ│</tg-emoji> <b>Method:</b> {method}\n"
                    f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
                    f"<tg-emoji emoji-id=\"5337132498965010628\">ЁЯУЮ</tg-emoji> <b>Number:</b> <code>{account_number}</code>\n"
            ...
            save_local_data()
            if target_msg_id: edit_message(chat_id, target_msg_id, "ЁЯТ│ <b>WITHDRAW METHODS</b>\nManage methods below:", reply_markup=dxa_manage_w_methods_keyboard())
            del user_states[user_id]
            delete_message(chat_id, message_id)
            return
            ...
            try:
                ...
                save_local_data()
                if target_msg_id: edit_message(chat_id, target_msg_id, "ЁЯТ░ <b>OTP REWARD CONTROL</b>\nManage rates below:", reply_markup=dxa_otp_control_keyboard())
            except ValueError: pass
            del user_states[user_id]
            delete_message(chat_id, message_id)
            return
            ...
            try:
                ...
                send_message(chat_id, "тЭМ Invalid format. Use: ServiceName - Rate (e.g. Telegram - 5.0)")
            del user_states[user_id]
            delete_message(chat_id, message_id)
            return
            ...
            try:
                ...
                if target_data:
                    msg = (
                        f"<tg-emoji emoji-id=\"5352861489541714456\">ЁЯСд</tg-emoji> <b>USER PROFILE</b>\n"
                        f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ\n"
                    ...
                    if target_msg_id: edit_message(chat_id, target_msg_id, "тЭМ <b>User not found in database!</b>", reply_markup=get_user_control_keyboard())
            except ValueError:
                if target_msg_id: edit_message(chat_id, target_msg_id, "тЭМ <b>Invalid User ID format!</b>", reply_markup=get_user_control_keyboard())
            del user_states[user_id]
            delete_message(chat_id, message_id)
            return
            ...
            try:
                ...
                target_data = get_user(target_uid)
                msg = (
                    f"тЬЕ <b>Balance Updated Successfully!</b>\n\n"
                    f"<tg-emoji emoji-id=\"5352861489541714456\">ЁЯСд</tg-emoji> <b>Name:</b> {html.escape(target_data['first_name'])}\n"
                    f"<tg-emoji emoji-id=\"5429612421977253466\">ЁЯТ╡</tg-emoji> <b>New Balance:</b> {target_data['balance']:.2f} BDT"
                )
                if target_msg_id: edit_message(chat_id, target_msg_id, msg, reply_markup=get_user_profile_keyboard(target_uid))
            except ValueError:
                if target_msg_id: edit_message(chat_id, target_msg_id, "тЭМ <b>Invalid amount format! Use numbers (e.g. 50 or -10).</b>", reply_markup=get_user_profile_keyboard(target_uid))
            del user_states[user_id]
            delete_message(chat_id, message_id)
            return
    ...
    if text.startswith("/start"):
            ...
            if param.startswith("alloc_"):
                try:
                    ...
                    if now - last_req < bot_settings.get("cooldown", 0):
                        send_message(chat_id, f"тМЫ <b>Please wait {int(bot_settings['cooldown'] - (now - last_req))} seconds before requesting again.</b>")
                        return
                    user_cooldowns[user_id] = now
                    
                    # ЁЯМЯ ржорзЗрж╕рзЗржЬ ржкрж╛ржарж┐рзЯрзЗ ржорзЗрж╕рзЗржЬ ржЖржЗржбрж┐ ржХрзНржпрж╛ржЪ ржХрж░рж╛
                    wait_msg = send_message(chat_id, f"тП│ <b>Fetching number for {req_sid.title().replace('_', ' ')}...</b>")
                    
                    msg, markup = get_number_allocation_content(req_sid, req_range, user_id=user_id)
                    
                    # ЁЯМЯ ржирждрзБржи ржорзЗрж╕рзЗржЬ ржирж╛ ржжрж┐рзЯрзЗ ржЖржЧрзЗрж░ржЯрж╛рждрзЗржЗ ржПржбрж┐ржЯ ржХрж░рж╛
        ...
        msg = (
            f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ\n"
            f"<tg-emoji emoji-id=\"5420145051336485498\">ЁЯСе</tg-emoji> <b>Referral Program</b>\n"
            f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ\n"
            f"<tg-emoji emoji-id=\"5420517437885943844\">ЁЯФЧ</tg-emoji> <b>Your Invite Link:</b>\n"
            f"<code>{invite_link}</code>\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"<tg-emoji emoji-id=\"5420396762189831222\">ЁЯОБ</tg-emoji> <b>PER INVITE : {ref_reward} TK</b>\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"<tg-emoji emoji-id=\"5353032893096567467\">ЁЯУК</tg-emoji> <b>Total Invites:</b> {user_data['total_invites']}\n"
            f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ"
        )
        ...
        wallet_txt = (
            f"<tg-emoji emoji-id=\"5429105001655999635\">ЁЯТ░</tg-emoji> <b>YOUR WALLET</b>\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"<tg-emoji emoji-id=\"5352861489541714456\">ЁЯСд</tg-emoji> <b>NAME :</b> {html.escape(str(first_name))}\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"<tg-emoji emoji-id=\"5226929552319594190\">ЁЯЖФ</tg-emoji> <b>ID :</b> <code>{user_id}</code>\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"<tg-emoji emoji-id=\"5429612421977253466\">ЁЯТ╡</tg-emoji> <b>BALANCE : {user_data['balance']:.2f} BDT</b>\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"<tg-emoji emoji-id=\"5190899075968441286\">ЁЯТ│</tg-emoji> <b>WITHDRAWAL METHODS :</b>"
        )
        kb = {"inline_keyboard": []}
        ...
        if user_id == ADMIN_ID:
            ...
            send_message(chat_id, "тЪая╕П <b>Access Denied!</b>\nThis menu is restricted to the admin.")
...
def handle_callback(callback_query):
    ...
    if data == "check_fj_joined":
        if is_user_joined(user_id):
            delete_message(chat_id, message_id)
            send_message(chat_id, "тЬЕ <b>Thank you for joining! You can now use the bot.</b>", reply_markup=get_main_keyboard(user_id))
        else:
            answer_callback_query(query_id, "тЭМ You haven't joined all channels!", show_alert=True)
        return
    ...
    if data.startswith("cc_"):
        ...
        edit_message(chat_id, message_id, f"тП│ <b>Fetching best top range and allocating number...</b>")
    ...
    if data.startswith("admin_w_approve_") or data.startswith("admin_w_reject_"):
        if user_id != ADMIN_ID:
            answer_callback_query(query_id, "тЪая╕П Access Denied! You cannot perform this action.", show_alert=True)
            return
        ...
        if action == "approve":
            ...
            send_message(req_user_id, f"<tg-emoji emoji-id=\"5420396762189831222\">ЁЯОЙ</tg-emoji> <b>Withdrawal Approved!</b>\nYour request of {amount:.2f} BDT has been sent to <code>{masked_number}</code>.")
        else:
            btn_text = "REJECTED BY ADMIN"
            btn_style = "danger"
            btn_icon = "5420130255174145507"
            update_user_stats(req_user_id, amount, 0)
            send_message(req_user_id, f"<tg-emoji emoji-id=\"5336944168944047463\">тЪая╕П</tg-emoji> <b>Withdrawal Rejected!</b>\nYour request of {amount:.2f} BDT to <code>{masked_number}</code> was rejected and refunded.")
            
        updated_msg = (
            f"<tg-emoji emoji-id=\"5420396762189831222\">ЁЯЖХ</tg-emoji> <b>WITHDRAW REQUEST PROCESSED</b>\n"
            f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ\n"
            f"<tg-emoji emoji-id=\"5352861489541714456\">ЁЯСд</tg-emoji> <b>User:</b> <a href='tg://user?id={req_user_id}'>{html.escape(req_first_name)}</a>\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"<tg-emoji emoji-id=\"5226929552319594190\">ЁЯЖФ</tg-emoji> <b>ID:</b> <code>{req_user_id}</code>\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"<tg-emoji emoji-id=\"5429612421977253466\">ЁЯТ╡</tg-emoji> <b>Amount:</b> <b>{amount:.2f} BDT</b>\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"<tg-emoji emoji-id=\"5190899075968441286\">ЁЯТ│</tg-emoji> <b>Method:</b> {req_method}\n"
            f"тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ тАФ\n"
            f"<tg-emoji emoji-id=\"5431783519355444455\">ЁЯУЮ</tg-emoji> <b>Number:</b> <code>{masked_number}</code>\n"
            f"тФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБтФБ"
        )
    ...
    if data == "manage_voltx":
        edit_message(chat_id, message_id, "ЁЯФС <b>VOLTX KEY SYSTEM</b>\nManage API Keys below:", reply_markup=get_voltx_keys_keyboard())
        answer_callback_query(query_id)
    elif data == "toggle_vk":
        ...
        edit_message(chat_id, message_id, "ЁЯФС <b>Please reply to this message with the new Voltx API Key.</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
    ...
    # ===== Force Join Manager =====
        ...
        edit_message(chat_id, message_id, "ЁЯФЧ <b>FORCE JOIN SYSTEM</b>\nManage channels below:", reply_markup=get_force_join_keyboard())
        answer_callback_query(query_id)
    elif data == "toggle_fj":
        ...
        select_kb = {"keyboard": [[{"text": "Select Force Join Channel", "request_chat": {"request_id": 3, "chat_is_channel": True}}], [{"text": "ЁЯФЩ BACK"}]], "resize_keyboard": True, "one_time_keyboard": True}
        send_message(chat_id, "ЁЯСЗ <b>Select Channel from below:</b>\n<i>(Make sure bot is an admin there)</i>", reply_markup=select_kb)
        answer_callback_query(query_id)
    ...
    # ===== OTP Group Manager =====
        ...
        edit_message(chat_id, message_id, "ЁЯЫб <b>OTP GROUP MANAGEMENT</b>\nManage settings below:", reply_markup=get_otp_group_keyboard())
        answer_callback_query(query_id)
    elif data == "add_otp_group":
        user_states[user_id] = {"state": "waiting_otp_group", "msg_id": message_id}
        select_kb = {"keyboard": [[{"text": "Select OTP Group", "request_chat": {"request_id": 1, "chat_is_channel": False}}], [{"text": "ЁЯФЩ BACK"}]], "resize_keyboard": True, "one_time_keyboard": True}
        send_message(chat_id, "ЁЯСЗ <b>Select OTP Group from below:</b>", reply_markup=select_kb)
        answer_callback_query(query_id)
        ...
        edit_message(chat_id, message_id, "ЁЯФЧ <b>Please send the new URL for the inline button attached to forwarded OTPs.</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
    elif data == "edit_main_channel":
        user_states[user_id] = {"state": "waiting_main_channel_link", "msg_id": message_id}
        edit_message(chat_id, message_id, "ЁЯФЧ <b>Please send the URL for the MAIN CHANNEL inline button.</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)

    # ===== DXA Control Panel =====
    elif data == "dxa_control":
        edit_message(chat_id, message_id, "тЪЩя╕П <b>DXA CONTROL PANEL</b>\nManage core bot configurations:", reply_markup=dxa_control_keyboard())
        answer_callback_query(query_id)
    elif data == "dxa_min_w":
        user_states[user_id] = {"state": "waiting_dxa_min_w", "msg_id": message_id}
        edit_message(chat_id, message_id, "ЁЯТ╕ <b>Enter new Minimum Withdraw Amount (e.g. 50):</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
    elif data == "dxa_ref_r":
        user_states[user_id] = {"state": "waiting_dxa_ref_r", "msg_id": message_id}
        edit_message(chat_id, message_id, "ЁЯТ╕ <b>Enter new Referral Reward Amount (e.g. 5.0):</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
    elif data == "dxa_otp_control":
        edit_message(chat_id, message_id, "ЁЯТ░ <b>OTP REWARD CONTROL</b>\nManage rates below:", reply_markup=dxa_otp_control_keyboard())
        answer_callback_query(query_id)
    elif data == "dxa_def_rate":
        user_states[user_id] = {"state": "waiting_dxa_def_rate", "msg_id": message_id}
        edit_message(chat_id, message_id, "ЁЯТ░ <b>Enter new Default OTP Rate (e.g. 0.5):</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
        ...
        edit_message(chat_id, message_id, "ЁЯТ░ <b>Enter Specific Service Rate.</b>\nFormat: <code>ServiceName - Rate</code>\nExample: <code>Telegram - 2.5</code>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
    elif data == "dxa_cool":
        user_states[user_id] = {"state": "waiting_dxa_cool", "msg_id": message_id}
        edit_message(chat_id, message_id, "тП│ <b>Enter new Cooldown time in seconds (e.g. 10):</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
    elif data == "dxa_num_req":
        user_states[user_id] = {"state": "waiting_dxa_num_req", "msg_id": message_id}
        edit_message(chat_id, message_id, "ЁЯУ▒ <b>Enter how many numbers a user gets per request (e.g. 3):</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
    elif data == "manage_w_methods":
        edit_message(chat_id, message_id, "ЁЯТ│ <b>WITHDRAW METHODS</b>\nManage methods below:", reply_markup=dxa_manage_w_methods_keyboard())
        answer_callback_query(query_id)
    elif data == "add_w_method":
        user_states[user_id] = {"state": "waiting_w_method", "msg_id": message_id}
        edit_message(chat_id, message_id, "ЁЯТ│ <b>Enter new Withdraw Method Name (e.g. bKash):</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
    ...
    # ===== User Control =====
        ...
        edit_message(chat_id, message_id, "ЁЯЖФ <b>Send the Telegram User ID to view profile:</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
        ...
        if bal < min_w:
            answer_callback_query(query_id, f"тЭМ Minimum withdraw is {min_w} BDT. You have {bal:.2f} BDT.", show_alert=True)
            return
            
        user_states[user_id] = {"state": f"waiting_withdraw_amount_{method}", "msg_id": message_id}
        edit_message(chat_id, message_id, f"ЁЯТ│ <b>Withdraw via {method}</b>\n\nЁЯТ╡ Your Balance: {bal:.2f} BDT\nЁЯТм <b>Enter the amount you want to withdraw:</b>", reply_markup=get_back_only_keyboard())
        answer_callback_query(query_id)
        return
